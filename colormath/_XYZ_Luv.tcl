...
# ::_XYZ_Luv
#
# Transform XYZ colors (without alpha channel) into Luv colors (without alpha channel).
...
# Each Luv color will be rappresented by 3 channels values in the following order and ranges:
#   L --> Lightness [0,100.0]
#   u --> u         [-134.0,220.0]
#   v --> v         [-140.0,122.0]
